...
export default function PrivacyPolicy() {
  return (
    <PrivacyPolicyLayout>
      <Box bgcolor={SEPARATOR_BACKGROUND} p="0 15px">
        <Paragraph>
          Protecting your private information is our priority. This Statement of
          Privacy applies to https://www.heyosmart.com/, and WE LIVE 4 and
          governs data collection and usage. For the purposes of this Privacy
          Policy, unless otherwise noted, all references to WE LIVE 4 include
          https://www.heyosmart.com/. The WE LIVE 4 website is a service and
          ecommerce site. By using the WE LIVE 4 website, you consent to the
          data practices described in this statement.
        </Paragraph>
        <Paragraph>
          Collection of your Personal Information In order to better provide you
          with products and services offered, WE LIVE 4 may collect personally
        ...
        <Paragraph>
          ...
          - E-mail Address <br />
          - Phone Number <br />
          - Service location addresses <br />
        </Paragraph>
        <Paragraph>
          If you purchase WE LIVE 4 products and services, we collect billing
        ...
        <Paragraph>
          ...
          identifiable information or personally sensitive data through WE LIVE
          4 public message boards, this information may be collected and used by
          others.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          Use of your Personal Information WE LIVE 4 collects and uses your
          personal information to operate and deliver the services you have
          requested.
        </Paragraph>
        <Paragraph>
          WE LIVE 4 may also use your personally identifiable information to
          inform you of other products or services available from WE LIVE 4 and
          its affiliates.
        </Paragraph>
        <Paragraph>
          Sharing Information with Third Parties WE LIVE 4 does not sell, rent
          or lease its customer lists to third parties.
        </Paragraph>
        <Paragraph>
          WE LIVE 4 may share data with trusted partners to help perform
          ...
          these services to WE LIVE 4, and they are required to maintain the
          confidentiality of your information.
        </Paragraph>
        <Paragraph>
          WE LIVE 4 may disclose your personal information, without notice, if
          ...
          legal process served on WE LIVE 4 or the site; (b) protect and defend
          the rights or property of WE LIVE 4; and/or (c) act under exigent
          circumstances to protect the personal safety of users of WE LIVE 4, or
          the public.
        </Paragraph>
        <Paragraph>
          Tracking User Behavior WE LIVE 4 may keep track of the websites and
          pages our users visit within WE LIVE 4, in order to determine what WE
          LIVE 4 services are the most popular. This data is used to deliver
          customized content and advertising within WE LIVE 4 to customers whose
          behavior indicates that they are interested in a particular subject
          area.
        </Paragraph>
        <Paragraph>
          Automatically Collected Information Information about your computer
          hardware and software may be automatically collected by WE LIVE 4.
          ...
          service, and to provide general statistics regarding use of the WE
          LIVE 4 website.
        </Paragraph>
        <Paragraph>Use of Cookies</Paragraph>
        <Paragraph>
          The WE LIVE 4 website may use &quot;cookies&quot; to help you
        ...
        <Paragraph>
          ...
          personalize WE LIVE 4 pages, or register with WE LIVE 4 site or
          services, a cookie helps WE LIVE 4 to recall your specific information
          ...
          and so on. When you return to the same WE LIVE 4 website, the
          information you previously provided can be retrieved, so you can
          easily use the WE LIVE 4 features that you customized.
        </Paragraph>
        <Paragraph>
          ...
          features of the WE LIVE 4 services or websites you visit.
        </Paragraph>
        ...
        <Paragraph>
          Security of your Personal Information WE LIVE 4 secures your personal
          information from unauthorized access, use, or disclosure. WE LIVE 4
        ...
        <Paragraph>Right to Deletion</Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          contract between you and us; <br />• Detect security incidents,
          ...
          functionality; <br />• Exercise free speech, ensure the right of
          another consumer to exercise his or her right of free speech, or
          exercise another right provided for by law; <br />• Comply with the
          California Electronic Communications Privacy Act; <br /> • Engage in
          ...
          ethics and privacy laws, when our deletion of the information is
          likely to render impossible or seriously impair the achievement of
          such research, provided we have obtained your informed consent; <br />
          • Enable solely internal uses that are reasonably aligned with your
          expectations based on your relationship with us; <br /> • Comply with
          an existing legal obligation; or <br />• Otherwise use your personal
          information, internally, in a lawful manner that is compatible with
          the context in which you provided the information. <br />
        </Paragraph>
        <Paragraph>Children Under Thirteen</Paragraph>
        <Paragraph>
          WE LIVE 4 does not knowingly collect personally identifiable
        ...
        <Paragraph>
          Disconnecting your WE LIVE 4 Account from Third Party Websites You
          will be able to connect your WE LIVE 4 account to third party
          accounts. BY CONNECTING YOUR HEYO SMART ACCOUNT TO YOUR THIRD PARTY
        ...
        <Paragraph>E-mail Communications</Paragraph>
        <Paragraph>
          From time to time, WE LIVE 4 may contact you via email for the purpose
          ...
          Services, we may receive a notification when you open an email from WE
          LIVE 4 or click on a link therein.
        </Paragraph>
        <Paragraph>
          If you would like to stop receiving marketing or promotional
          communications via email from WE LIVE 4, you may opt out of such
          communications by Customers may unsubscribe from emails by
          &quot;replying STOP&quot; or &quot;clicking on the UNSUBSCRIBE
          button.&quot;.
        </Paragraph>
        <Paragraph>External Data Storage Sites</Paragraph>
        <Paragraph>
          We may store your data on servers provided by third party hosting
          vendors with whom we have contracted.
        </Paragraph>
        <Paragraph>Changes to this Statement</Paragraph>
        <Paragraph>
          WE LIVE 4 reserves the right to change this Privacy Policy from time
          ...
          continued use of the website and/or Services
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          WE LIVE 4 welcomes your questions or comments regarding this Statement
          of Privacy. If you believe that Heyo Smart has not adhered to this
          Statement, please contact Heyo Smart at:
        </Paragraph>
        <Paragraph>
          WE LIVE 4 <br /> 900 Easton Ave Ste 26 PMB 1036 <br /> Somerset, New
          Jersey 08873
        </Paragraph>
        <Paragraph>
          Email Address: <br /> hi@heyosmart.com
        </Paragraph>
        <Paragraph>Telephone number: (844) WE-LIVE-4</Paragraph>
        <Paragraph>Effective as of April 04, 2021</Paragraph>
      </Box>
    </PrivacyPolicyLayout>
  );
}
