export const blackCardsData = [
  ...
  },
  {
    ...
    firstdescription:
      "Discover WE LIVE 4 Wireless Access Points (WAPs) - the significant change for spotty Wi-Fi.",
    seconddescription:
      "Unlike Ethernet cables that restrain you to a fixed location, WE LIVE 4 WAPs offer wireless freedom, allowing you to roam your home or business freely with a strong, consistent signal. ",
  },
  {
    title: "NEXT-GEN WIFI",
    firstdescription:
  ...
  },
  {
    title: "MULTI-GPS",
    firstdescription:
      "Multiple internet service providers (Multi-ISPs) allows you to use multiple internet service providers instead of just one. You can ensure redundancy and flexibility in your network.",
    seconddescription:
